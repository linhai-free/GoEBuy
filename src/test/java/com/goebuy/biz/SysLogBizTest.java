...
public class SysLogBizTest extends TestCase {
...
//	 ApplicationContext ctx;
	...
	public void testListAll() {
		List<SystemLog> roleList =biz.findAll();
		if(roleList!=null) {
			for(SystemLog r : roleList ) {
				System.out.println("SystemLog: " + r );
			}
		}else {
			System.out.println("SystemLogs is null");
		}
	}
